...
def assemble_signature(password: str, salt: str):
    ...
    print(f'In assemble_sig Salted:')
    print(salted)
    print(f'length of salted is {len(salted)}')
    print(f'type of salted {type(salted)}')
    print(str.encode(salted))
    # print(salted.hex())
                ...
                if peer not in [my_address, new_address]:
                    ...
                    server.send_to_server(
                        assemble_message(
                            ...
                            msg), 
                        expect_reply=False)
                    print(f'Informing {peer_port} about {port}')
                    print(network_signature.hex())
                    print(network_salt)
...
if __name__ == "__main__":
    ...
    print(f'Startup {signature.hex()} {salt}')
